...
namespace MonoGame.src.entity.airdrops {
    class Turretpack : Airdrop {
        public Turretpack(int x, int y) {
            this.x = x;
            this.y = y;
            this.frameWidth = 96;
            ...
            this.additionalSpritePath = "textures/props/turretIcon";
        ...
        public override void Update(GameTime gameTime) {
            ...
            if (PickedUp() && IsVisible()) {
                GameController.view.huds.Add(new Popup(x - frameWidth / 2, y + frameHeight / 2, "+1 Turret", Color.Yellow, 3.5f));
                GameController.view.GetPlayer().AddTurrets(1);
                sound.Play();
                Remove();
            }
        }
