...
namespace MonoGame.src.entity.airdrops {
    public class Bardwirepack : Airdrop {
        public Bardwirepack(int x, int y) {
            this.x = x;
            this.y = y;
            this.frameWidth = 96;
            ...
            this.additionalSpritePath = "textures/props/barbedWire";
        ...
        public override void Update(GameTime gameTime) {
            ...
            if (PickedUp() && IsVisible()) {
                GameController.view.huds.Add(new Popup(x - frameWidth / 2, y + frameHeight / 2, "+1 Barbwire", Color.Yellow, 3.5f));
                GameController.view.GetPlayer().AddBarbwire(1);
                sound.Play();
                Remove();
            }
        }
